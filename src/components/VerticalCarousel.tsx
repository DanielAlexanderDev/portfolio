...
const VerticalCarousel = () => {
  return (
    <div className="md:min-w-[350px] animate-fade-in md:w-1/3 md:h-[500px] h-auto min-w-[350px] w-2/3 md:relative border-2  md:flex md:items-center rounded-md md:justify-center py-2 md:px-4 mb-5 md:mb-0">
      <div className="md:min-w-[350px]  md:h-full h-full  md:max-h-96 md:overflow-y-hidden scrollbar-hide scroll-smooth  md:grid flex  overflow-x-hidden md:px-3  ">
        <div className="w-full h-[370px]"></div>
        <img
